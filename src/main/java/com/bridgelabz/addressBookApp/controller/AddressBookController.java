...
import com.bridgelabz.addressBookApp.exceptionHandling.AddressBookException;
...
public class AddressBookController {
	...
	public ResponseEntity<ResponseDTO> saveAddressBook(@Valid @RequestBody AddressBookDTO dto) {
		AddressBookDTO data = service.saveAddressBook(dto);
		ResponseDTO responseDTO = new ResponseDTO("AddressBook Entity saved ", data);
	...
	public ResponseEntity<ResponseDTO> getAddressBook() {
		List<AddressBookDTO> addressBookList = service.getAddressBook();
	...
	public ResponseEntity<ResponseDTO> getAddressBookByID(@PathVariable("id") int id) {
		AddressBookDTO dto = service.getAddressBookById(id);
		ResponseDTO responseDTO = new ResponseDTO(" Retrived the data from address book ", dto);
	...
	public ResponseEntity<ResponseDTO> updateAddressBookByID(@Valid @PathVariable("id") int id,
			@RequestBody AddressBookDTO dto) {

		AddressBookDTO updateddata =  service.updateAddressBookByID(id, dto);
		ResponseDTO responseDTO = new ResponseDTO(" Updated the data from address book ", updateddata);
		return new ResponseEntity<ResponseDTO>(responseDTO, HttpStatus.OK);
	...
	/*
	 * @DeleteMapping("/delete/{id}") public ResponseEntity<ResponseDTO>
	 * deleteAddressbookByID(@PathVariable("id") int id){
	 * 
	 * AddressBookData entity = service.deleteAddressbookByID(id); ResponseDTO
	 * responseDTO = new ResponseDTO(" Deleted the data from address book ",
	 * entity); return new ResponseEntity<ResponseDTO>(responseDTO, HttpStatus.OK);}
	 */
}
